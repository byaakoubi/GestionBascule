...
namespace GestionBascule
{
    public partial class SortieStock : Form
    {
        ...
        public SortieStock(double poids_bascule_)
        {
            InitializeComponent();
            this.Text = "Sortie Stock : Pesage 1";
        ...
        /// <param name="poids_bascule_"></param>
        /// <param name="owner_"></param>
        public SortieStock(int entry_n, double poids_bascule_)
        {
            InitializeComponent();
            this.Text = "Sortie Stock : Pesage 2";
            operation = 1;
        ...
        public SortieStock(int entry_n)
        {
            InitializeComponent();
            this.Text = "Sortie Stock : Modification Pesage";
            operation = 2;
            _p = PesageHeaderDao.getPesageHeader(entry_n);
        ...
        {
            LineClient _form = new LineClient(_p.entry_n);
        ...
        private void editer_b_Click(object sender, EventArgs e)
        {
            ...
            {
                int entry_n = int.Parse(BLs_DGV.CurrentRow.Cells["Entry N°"].Value.ToString());
                LineClient _form = new LineClient(_p.entry_n, entry_n);
                if (_form.ShowDialog() == DialogResult.OK)
                {
                    poids_recep_tb.Text = PesageHeaderDao.updateWeightPesageHeader(_p.entry_n).ToString();
                    getBLs(_p.entry_n);
